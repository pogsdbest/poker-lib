...
namespace Main {
    class Program {
        static void Main( string[] args ) {
            ...
            PrintResult(poker.Evaluate ( pokerHandsRanking ));
            ...
            PrintResult ( poker.Evaluate ( straightFlushTieBreaker ));
            ...
            PrintResult ( poker.Evaluate ( royalFlushTie ) );
            ...
            PrintResult ( poker.Evaluate ( fourOfAkindTie ));
            ...
            PrintResult ( poker.Evaluate ( fullHouseTie ));
            ...
            PrintResult ( poker.Evaluate ( flushTie ));
            ...
            PrintResult ( poker.Evaluate ( straightTie ));
            ...
            PrintResult ( poker.Evaluate ( threeOfAKindTie ));
            ...
            PrintResult ( poker.Evaluate ( twoPairTie ));
            ...
            PrintResult ( poker.Evaluate ( onePairTie ));
            ...
            PrintResult ( poker.Evaluate ( highCardTie ));
        }

        static void PrintResult(List<PlayerHand> winners) {
            foreach(PlayerHand winner in winners) {
                Console.WriteLine ("Winner: "+winner.playerName+" "+winner.GetCardString()+" - "+winner.pokerHandName+" ("+winner.tieInfo+")");
            }
            Console.WriteLine ();
        }
    }
